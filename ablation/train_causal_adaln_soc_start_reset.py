...
PROJECT = "PINT_SchemeB_CAUSAL_ADALN_SOC_START_RESET"
...
def _make_results_dirs():
    base = organized_results_dir() / "ablation" / "soc_start_reset"
    cache_dir = base / "pt"
...
def main():
    parser = argparse.ArgumentParser(description="Train causal AdaLN model with one SOC-start hidden-state reset per segment.")
