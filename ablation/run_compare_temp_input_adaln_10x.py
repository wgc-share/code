...
def main():
    ...
    parser.add_argument("--scope", choices=["filtered", "extrapolation"], default="filtered")
    ...
    methods = METHOD_SETS[args.scope]
    ...
    plan_path = run_root / f"{args.scope}_plan.csv"
    status_path = run_root / f"{args.scope}_status.csv"
